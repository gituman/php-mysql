      ...
      <div class="col-md-4 offset-md-4 form-wrapper">
        ...
        <form action="signup.php" method="post">
          ...
          <label>platform</label> 
            ...
            <input type="radio" name="platform"  value="steam"> steam
            </div>
            <div class="form-group">
            <label>region</label>
            <input type="radio" name="region"  value="kenya" required> kenya
            <input type="radio" name="region"  value="uganda"> uganda
            <input type="radio" name="region"  value="tanzania"> tanzania 
            </div>
            <div class="form-group">
